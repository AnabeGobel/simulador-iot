...
__name$8(useStateMachine, "useStateMachine");
var Presence = /* @__PURE__ */ __name$8((props) => {
...
function usePresence(present) {
	...
	useLayoutEffect2(() => {
		if (node) {
			...
			const handleAnimationEnd = /* @__PURE__ */ __name$8((event) => {
			...
			const handleAnimationStart = /* @__PURE__ */ __name$8((event) => {
...
__name$8(usePresence, "usePresence");
function setRef(ref, value) {
	if (typeof ref === "function") return ref(value);
	else if (ref !== null && ref !== void 0) ref.current = value;
}
__name$8(setRef, "setRef");
...
__name$8(useStableComposedRefs, "useStableComposedRefs");
function getAnimationName(styles) {
	return styles?.animationName || "none";
}
__name$8(getAnimationName, "getAnimationName");
...
//#endregion
export { createSlot as C, Slot$1 as S, require_jsx_runtime as T, Presence as _, Overlay2 as a, createContextScope as b, Title2 as c, Portal as d, useId as f, useCallbackRef$1 as g, DismissableLayer as h, Description2 as i, ReactRemoveScroll as l, useFocusGuards as m, Cancel as n, Portal2 as o, FocusScope as p, Content2 as r, Root2 as s, Action as t, hideOthers as u, useControllableState as v, useComposedRefs as w, Primitive as x, useLayoutEffect2 as y };
