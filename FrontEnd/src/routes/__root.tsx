...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Sistema de monitorização de energia IoT" },
      { name: "author", content: "IoT Caálá" },
      { property: "og:title", content: "IoT Energia Caálá" },
      { property: "og:description", content: "Sistema de monitorização de energia IoT" },
